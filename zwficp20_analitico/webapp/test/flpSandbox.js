		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Analitico Negoziazioni",
									"targetURL": "#zwficp20analitico-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zwficp20analitico-display": {
								"semanticObject": "zwficp20analitico",
								"action": "display",
								"description": "Analitico Negoziazioni",
								"title": "Analitico Negoziazioni",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zwficp20analitico",
									"url": sap.ui.require.toUrl("zwficp20analitico")
								}
							}
						}
					}
